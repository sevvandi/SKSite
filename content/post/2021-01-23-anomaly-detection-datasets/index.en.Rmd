...
summary: ''
authors: []
lastmod: '2021-01-223T09:39:22+11:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
This is a really good website that provides multi-dimensional point datasets, time series graph datasets for event detection, time series point datasets, adversarial attack and security datasets and crowd scene video datasets. They describe the datasets well and provide references. 
